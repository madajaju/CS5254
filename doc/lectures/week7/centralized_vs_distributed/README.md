...
- Week: 7
- Lecture: Centralized vs. Distributed Coordination
- Duration: 15 minutes
...
## Learning Objectives
- Analyze the design pressure represented by centralized vs. distributed coordination in a stateful concurrent system.
...
Diagram intent:
- Show the normal interaction before Coordination Boundary is placed under pressure.
...
### Evidence Flow
Claim:
- Centralized vs. Distributed Coordination is correctly handled when the order workflow preserves prerequisites and progress under pressure.
...
- Identify the invariant or progress property most relevant to centralized vs. distributed coordination.
...
- **A2 Alignment**: Part 8 of A2 requires you to "Compare Two Coordination Strategies." This lecture provides the specific pros and cons for the Centrali
