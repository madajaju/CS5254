...
## Video: https://youtu.be/GQJZ7kKIDsE
## Metadata
...
## Learning Objectives
- Analyze the design pressure represented by coordination patterns in a stateful concurrent system.
...
### Evidence Flow
Claim:
- Coordination Patterns is correctly handled when the order workflow preserves prerequisites and progress under pressure.
...
- Identify the invariant or progress property most relevant to coordination patterns.
