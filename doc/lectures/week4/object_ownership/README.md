...
## Learning Objectives
- Analyze the design pressure represented by object ownership & thread confinement in a stateful concurrent system.
...
## Opening Narrative
A course project appears correct during a simple demonstration. Once concurrency, ambiguity, or operational pressure is introduced, the design exposes a hidden assumption about Thread Confinement. What must the engineer analyze and defend before trusting the result?

## Core Concepts
### Thread Confinement
- Definition: Restricting an object's access to a single thread so that no synchroni
...
Diagram intent:
- Show the normal interaction before Thread Confinement is placed under pressure.
...
### Evidence Flow
Claim:
- Object Ownership & Thread Confinement is handled when the invariant survives an intentionally bad interleaving.
...
- Identify the invariant or progress property most relevant to object ownership & thread confinement.
