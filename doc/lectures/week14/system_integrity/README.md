...
- Week: 14
- Lecture: System Integrity Under Pressure
- Duration: 15 minutes
...
## Learning Objectives
- Analyze the design pressure represented by system integrity under pressure in a stateful concurrent system.
...
## Opening Narrative
A course project appears correct during a simple demonstration. Once concurrency, ambiguity, or operational pressure is introduced, the design exposes a hidden assumption about System Integrity. What must the engineer analyze and defend before trusting the result?

## Core Concepts
### System Integrity
- Definition: The property where a system maintains its invariants and data consistency regardless of concurrency, load, or partial failure.
...
### The Integrity Chain
- Definition: How object boundaries, synchroni
- Why it matters: This concept identifies a condition that must be made explicit before the system can be trusted under pressure.
- Mechanism: It appears through object state, workflow timing, worker behavior, retries, queues, or coordination boundaries.
- Failure mode: If ignored, the system can pass the happy path while producing duplicate work, stale state, blocked progress, or misleading evidence.
- Design implication: The implementation should expose the relevant invariant, log the critical transition, and validate behavior with a repeatable test.
...
Diagram intent:
- Show the normal interaction before System Integrity is placed under pressure.
...
### Evidence Flow
Claim:
- System Integrity Under Pressure is defensible when the design shows both the failure and the recovery path with measurements.
...
- Identify the invariant or progress property most relevant to system integrity under pressure.
...
- **A4 Alignment**: This lecture directly supports Part 7 of A4: "Final Integrity Packet." It helps you summari
