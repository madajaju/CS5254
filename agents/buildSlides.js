    ...
    const messages = [
        {
            ...
            content: [
                ...
                '* Table slides must use [.stretch] followed by [cols="1,1,1,1", options="header", width="100%"], |===, rows, then closing |===.',
                ...
                '* Aim for 45-60% of == slides to be diagram-only PlantUML slides; if the ratio is below 45%, add separate diagram-only slides where concepts can be visualized.',
                '* Add separate diagram-only slides for concepts, failure scenarios, workflows, and design responses when possible.',
                '* PlantUML blocks must use width=100%.',
                '* PlantUML must use BackgroundColor #123456, DefaultFontColor black, ArrowColor white, ArrowFontColor #ffd166, ArrowFontStyle bold, ArrowFontSize 16, white boxes with black box text, and BorderColor #123456.',
                '* Sequence diagrams must include white lifelines and high-contrast participant styling: LifeLineBorderColor white, LifeLineBackgroundColor white, ParticipantBorderColor #123456, ParticipantBackgroundColor white, ParticipantFontColor black.',
                '* For labeled relationships, use longer arrows such as A --> B : label, not short arrows such as A -> B : label.',
    ...
    const messages = [
        {
            ...
            content: [
                ...
                '* Tables must use [.stretch] followed by [cols="1,1,1,1", options="header", width="100%"], an opening |===, AsciiDoc rows, and a closing |===.',
